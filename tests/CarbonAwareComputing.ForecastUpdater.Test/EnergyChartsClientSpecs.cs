...
namespace CarbonAwareComputing.ForecastUpdater.Test
{
    public abstract class EnergyChartsTransformContextSpecification : ContextSpecification
    {
        ...
        {
            var root = m_EnergyChartsClient!.GetCarbonGridIntensityForecastAsync(m_Country!);
    ...
    [TestClass]
    public class Given_a_energy_chart_client_with_de_co2_data : EnergyChartsTransformContextSpecification
    {
        protected override void Given()
        {
            m_ContentFile = Encoding.UTF8.GetString(Properties.Resources.de_co2);
            m_Country = "de";
            base.Given();
        }
